...
- A frontier-lab business / regulatory story (M&A, fundraising, partnerships,
  policy decisions affecting deployment).
- Technical depth from a known practitioner blog (Simon Willison, Import AI,
  TestingCatalog, HuggingFace blog, Anthropic research, OpenAI engineering).

Bias the score DOWN when the story is:
- An AI thinkpiece without specific evidence or named techniques.
- A general "AI is transforming X industry" piece without operational detail.
- Repeated coverage of a model release we've covered in the last 7 days.
- Career-advice or hiring content not about AI engineering practice.
